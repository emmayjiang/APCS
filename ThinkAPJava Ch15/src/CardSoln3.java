 ...
 * Exercise 1 (edits) and 5 of ThinkAPJava Chapter 15
 *
...
class Deck {
	 ...
	 * 
	 * This method was edited into an object method.
	 */
	 ...
	 * 
	 * Edited in order to make merge an object method.
	 */
	public Deck mergeSort() {
		...
		Deck d1 = subdeck(0, mid).mergeSort();
		Deck d2 = subdeck(mid + 1, cards.length - 1).mergeSort();
